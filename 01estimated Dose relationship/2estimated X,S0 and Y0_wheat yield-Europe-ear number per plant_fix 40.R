...
#ggsave(file.path(Outputfolder,paste0('Figure','/Europe_ear number per plant_AOT40.png')),width = 12, height = 8,units = "cm",dpi=400)
...
#ggsave(file.path(Outputfolder,paste0('Figure','/Europe_ear number per plant_M12.png')),width = 12, height = 8,units = "cm",dpi=400)

RY_result<-list(result,modelresult,pars,percentile_intervals)
export(RY_result,file.path(Outputfolder,"Europe_wheat_result_ear number per plant_fix40.xlsx"),overwrite=T)
