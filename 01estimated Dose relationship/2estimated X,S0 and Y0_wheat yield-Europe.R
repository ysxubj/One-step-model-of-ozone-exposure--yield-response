...
ggsave(file.path(Outputfolder,paste0('Figure','/Europe_wheat_AOT40.png')),width = 12, height = 8,units = "cm",dpi=400)
...
ggsave(file.path(Outputfolder,paste0('Figure','/Europe_wheat_M12.png')),width = 12, height = 8,units = "cm",dpi=400)

pars[2]<-y
RY_result<-list(result,modelresult,pars,percentile_intervals)
export(RY_result,file.path(Outputfolder,"Europe_wheat_result.xlsx"),overwrite=T)
